...
function uninstallApp(e) {   
    ...
    if (1 == confirm("Are you sure you want to delete this app? You'll lose all your saved data!")) {
        ...
        alert("App uninstalled. You may need to restart Brew OS Pro to finish uninstalling.")
    }
...
const menu = new Audio("https://bloxdeck.github.io/sounds/deck_ui_misc_08.wav")
     menu.play();
